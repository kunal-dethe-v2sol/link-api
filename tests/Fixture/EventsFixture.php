...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'host_to' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'event_fee' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'event_type' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'events_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'uuid'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'uuid' => '3d6efd6b-a47e-4588-a274-b0a658a41461',
            'user_id' => '0e337092-0842-4fb4-b469-b0590acd8615',
            ...
            'host_to' => 'Lorem ipsum dolor sit amet',
            'event_fee' => 1,
            'event_type' => 'Lorem ipsum dolor sit amet',
            'created' => '2017-08-31 07:21:38',
            'created_by' => '00dadb06-c112-4b18-af13-8e3257a0cd71',
            'modified' => 1504164098,
            'modified_by' => '4334a245-e007-4582-9ca1-58c0c1133318'
        ],
    ];
}
